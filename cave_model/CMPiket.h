...
public:
	...
	const float* getMinCutDimension() const { return minCutDimension; }
	void setMinCutDimension(float dim) { delete minCutDimension; minCutDimension = new float(dim); }
...
public:
  ...
  //	const V3& pos() const { return allP3D.front().pos; }
	...
	void resetCache() const { cache.reset(); };
